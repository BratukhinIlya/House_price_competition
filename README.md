...
Отдельно представлено решение методом **градиентного поиска**, так как в нем необходимо было сначала **стандартизировать** данные, а уже потом делать численные вычисления. Файл: `Gradient_find_for_big_data.ipynb`
